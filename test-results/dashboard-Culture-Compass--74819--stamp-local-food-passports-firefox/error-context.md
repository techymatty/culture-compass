...
- Name: dashboard.spec.ts >> Culture Compass AI - E2E Core Journeys >> should checkoff quests and stamp local food passports
...
Locator: locator('h4:has-text("Kyoto Matcha")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h4:has-text("Kyoto Matcha")')
...
- complementary:
  ...
  - text: My Account
- main:
  - text: Adventurer Level
  - heading "Level 1 Traveler" [level=2]
  - paragraph: Earn XP by completing daily cultural quests and stamping local specialties in your Food Passport.
  - text: XP Gauge 0 Total XP 100 XP until Level 2
  - heading "Active Cultural Quests" [level=3]
  - text: +50 XP
  - heading "Local Conversationalist" [level=4]
  - paragraph: Learn and practice 3 common local greetings with pronunciation.
  - button "Claim XP"
  - text: +50 XP
  - heading "Gastronomy Discovery" [level=4]
  - paragraph: Taste a traditional dish and record its origin in your Food Passport.
  - button "Claim XP"
  - text: +100 XP
  - heading "Heritage Chronicler" [level=4]
  - paragraph: Explore a UNESCO World Heritage site or historical monument.
  - button "Claim XP"
  - heading "Food Passport Stamps" [level=3]
  - heading "Passport is empty" [level=4]
  - paragraph: Stamp your first dish using the logger on the right to start your log.
  - heading "Stamp Passport" [level=3]
  - paragraph: Sampled a traditional culinary dish? Stamp it inside your passport to record its cultural background and gain 20 XP.
  - text: Destination
  - combobox:
    ...
    - option "Paris (France)"
  - text: Dish Name
  - textbox "e.g. Kyoto Yudofu, Rome Carbonara": Kyoto Matcha
  - text: Cultural & Historical Significance
  - textbox "Describe where it originated, key ingredients, or the ceremony behind serving it.": Traditional green tea served in Arashiyama ceremony.
  - text: Photo URL (Optional)
  - textbox "https://example.com/food.jpg"
  - text: My Review / Tasting Notes (Optional)
  - textbox "e.g. Creamy, subtle sesame flavors"
  - button "Stamp Passport (+20 XP)"
- img
- text: 1 error
- button "Hide Errors":
  - img
